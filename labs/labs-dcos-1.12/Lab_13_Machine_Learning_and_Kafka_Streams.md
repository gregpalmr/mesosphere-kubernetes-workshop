## - Lab 13 - Setting up a Machine Learning process with Kafka Streams

## Kafka Streams Example

For this example we will show you how easy it is to run your microservices and dataservices in one single DC/OS cluster using the same resources.
...
## Uninstall ML-Kafka Stream example
